    ...
    <div class="container-fluid">
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="container">
            <h1>Home</h1>
            <p>Welcome to the Recommendations, reputation and reviews site.<br>
                Here you'll find recommedantions on products, reputation of companies, people and reviews of products.</p>
